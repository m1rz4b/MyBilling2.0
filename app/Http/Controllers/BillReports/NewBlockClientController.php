...
class NewBlockClientController extends Controller
{
...
$client_list = Customer::query()
  ...
  //      ->where('mas_collections.collection_date', $start_date);
 	...
 	//$cond
		...
		$client_list->where('trn_clients_services.bill_start_date','>=' ,$start_date);
		$client_list->where('trn_clients_services.bill_start_date','<=' ,$end_date);
...
///////////////////////////
        ...
        return view("pages.billing.reports.newBlockClient", compact("menus", "zones", "client_category", "status_types", "customers", "client_list", "selectedZone", "selectedPackage", "selectedCustomerStatus", "selectedCurrentStatus", "selectedCustomer","branches","start_date","selectedBranch","selectedcategory","clienttypes",'block_list','end_date'));
    }
