...
class DueListDateRangeController extends Controller
{
 ...
 $due_lists = MasInvoice::query()
		...
		->orderBy('invoice_number');
 		...
 		$due_lists->where('invoice_date','>=' ,$start_date);
		$due_lists->where('invoice_date','<=' ,$end_date);
        ...
        return view("pages.billing.reports.dueListDateRange", compact("menus", "zones", "client_category", "status_types", "customers", "due_lists", "selectedZone", "selectedPackage", "selectedCustomerStatus", "selectedCurrentStatus", "selectedCustomer","branches","start_date","end_date","selectedBranch","selectedcategory"));
    }
