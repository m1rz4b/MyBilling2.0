...
class DiscountInCollectionController extends Controller
{
 ...
 $cust_invoices = MasCollection::query()
        ...
        return view("pages.billing.reports.discountInCollection", compact("menus", "zones", "client_category", "status_types", "customers", "cust_invoices", "selectedZone", "selectedPackage", "selectedCustomerStatus", "selectedCurrentStatus", "selectedCustomer","branches","start_day","start_month","start_year","selectedBranch","selectedcategory"));
    }
