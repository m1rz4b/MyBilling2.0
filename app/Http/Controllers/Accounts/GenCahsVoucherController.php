...
class GenCahsVoucherController extends Controller
{
 ...
 $collection_lists = MasCollection::query()
        ...
        return view("pages.accounts.genCahsVoucher", compact("menus", "zones", "client_category", "status_types", "customers", "collection_lists", "selectedZone", "selectedPackage", "selectedCustomerStatus", "selectedCurrentStatus", "selectedCustomer","branches","start_date","end_date","selectedBranch","selectedcategory","costcenters","selectedcostcenter"));
    }
...
//$journalNo = 1;
	...
	//	$journal_id=createJournal($journal,'CR');
        ...
        DB::select($latestjournalnumber);			
		 ...
		 return redirect('/gencahsvoucher')->with('success', 'Credit Voucher Generated Successfully');
    }
