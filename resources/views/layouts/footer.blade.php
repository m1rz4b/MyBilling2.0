    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="footer_iner text-center">
          <p>
            2024 © MyBilling 2 - Designed by
            <a href="#"> <i class="ti-heart"></i> </a
            ><a href="#"> Nextech Ltd.</a>
          </p>
        </div>
      </div>
    </div>
...
<div class="CHAT_MESSAGE_POPUPBOX">
  ...
  <script src="{{url('vendors/apex_chart/apex_realestate.js') }}"></script>
  ...
  <script src="{{url('vendors/apex_chart/apexchart_lists.js') }}"></script>
  <script src="{{url('vendors/chartjs/chartjs_init.js') }}"></script>
