    ...
    <div class="container-fluid p-0 sm_padding_15px">
        <div class="px-4 py-1 theme_bg_1">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0" style="color: white;">Monthly Deduction Component</h5>
            </div>
        </div>
        <form action="{{ route('deductioncomponent.show') }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('post')
            <div class="row p-3">
        ...
        <div class="QA_table px-3">
            ...
            <table class="table">
                ...
                <tbody>
                    @foreach ($hrm_emp_monthly_deduct as $hrm_emp)
                    <tr>
                        <td>{{ $count++ }}</td>
                        ...
                        <td>{{ $hrm_emp->amnt }}</td>
                        <td>
                            <button href="#" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#edit_deduction_component_modal-{{ $hrm_emp->id }}">Edit</button>
                        </td>
                    </tr>

                    <!-- Edit Modal -->
                    <div class="modal fade" id="edit_deduction_component_modal-{{$hrm_emp->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="{{route('deductioncomponent.update', ['deductioncomponent' => $hrm_emp])}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    <div class="modal-header theme_bg_1">
                                        <h1 class="modal-title fs-5 text-white" id="exampleModalLabel">Edit Deduction Component</h1>
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="mb-2">
                                                    <label for="deduct_comp_name">Deduction Component</label>
                                                    <input type="text" class="form-control" value="{{ $hrm_emp->deduct_comp_name}}" name="deduct_comp_name" id="deduct_comp_name" readonly>
                                                </div>
                                                <div class="mb-2">
