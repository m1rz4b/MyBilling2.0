...
@section('main-container')
    ...
    <div class="main_content_iner mt-0">
        ...
        <div class="container-fluid p-0 sm_padding_15px">
            <div class="">
                <div class="px-4 py-1 theme_bg_1">
                    <h5 class="mb-0 text-white text-center">Genral Ledger</h5>
                </div>
            </div>

            <form action="{{ route('generalledger.show') }}" method="get">
                @csrf
                <div class="m-3">
                    <div class="row mb-3">
                  ...
                  <div class="col-sm-3">
					...
					<h5 class="mb-0 text-center">Genral Ledger  {{ $glcodeName }}</h5>
            ...
            <div class="QA_table p-3 pb-0 table-responsive">
                ...
                <table class="table table-responsive">
					...
					<th rowspan='2' align='center'>Cost Center/Department</th>
					<th  align='center' colspan='2'>Period Transaction</th>
					<th  align='center' colspan='2'>Balance</th>
                     </tr>
					 <tr>
		...
		@endphp
							...
							<td > {{ $masjournal->remarks  }}</td>
                            <td align='right'>{{ $masjournal->customer_name  }}</td>
                            <td align='right'>{{ $DrAmount  }}</td>
                            <td align='right'>{{ $CrAmount  }} </td>
							<td align='right'>{{ $BlDrAmount  }}</td>
                            <td align='right'>{{ $BlCrAmount  }} </td>
                        </tr>		
				@endforeach 
