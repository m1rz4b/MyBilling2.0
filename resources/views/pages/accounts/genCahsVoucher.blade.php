        ...
        <div class="container-fluid p-0 sm_padding_15px">
            <div class="">
                <div class="px-4 py-1 theme_bg_1">
                    <h5 class="mb-0 text-white text-center">Cash Voucher Generation</h5>
                </div>
            </div>

            <form action="{{ route('gencahsvoucher.show') }}" method="get">
                @csrf
                <div class="m-3">
                    <div class="row mb-3">
				  ...
				  <label class="fw-medium" for="end_date" class="form-label">Zone</label>
					...
					<h5 class="mb-0 text-center">Cash Voucher Generation</h5>
					<h5 class="mb-0 text-center">Date From {{ $start_date}} To {{ $end_date}}</h5>
					
                </div>
				
            <form action="{{ route('gencahsvoucher.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
