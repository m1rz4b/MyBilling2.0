        ...
        <div class="container-fluid p-0 sm_padding_15px">
            <div class="">
                <div class="px-4 py-1 theme_bg_1">
                    <h5 class="mb-0 text-white text-center">Generate Bkash Voucher</h5>
                </div>
            </div>

            <form action="{{ route('genbkashvoucher.show') }}" method="get">
                @csrf
                <div class="m-3">
                    <div class="row mb-3">
				  ...
				  <label class="fw-medium" for="end_date" class="form-label">Zone</label>
					...
					<div class="col-sm-4">
					 <div class="input-group input-group-sm flex-nowrap">
							<select class="select2 form-select form-select-sm" id="payment_from" name="payment_from">
                                ...
                                <option value="1">PGW</option>
                                <option value="2">WebHook</option>
                                <option value="3">Bill Pay</option>
                            </select>
                    </div>
                    </div>
                      <div class="col-sm-4">
					...
					<h5 class="mb-0 text-center">Generate Bkash Voucher</h5>
					<h5 class="mb-0 text-center">Date From {{ $start_date}} To {{ $end_date}}</h5>
					
                </div>
				
            <form action="{{ route('genbkashvoucher.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
