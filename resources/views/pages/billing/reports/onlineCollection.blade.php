        ...
        <div class="container-fluid p-0 sm_padding_15px">
            <div class="">
                <div class="px-4 py-1 theme_bg_1">
                    <h5 class="mb-0 text-white text-center">Online Collection</h5>
                </div>
            </div>

            <form action="{{ route('onlinecollection.show') }}" method="get">
                @csrf
                <div class="m-3">
                    <div class="row mb-3">
                  ...
                  <div class="col-sm-2 form-group">
					...
					<h5 class="mb-0 text-center">Online Collection</h5>
                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           <td>{{ $cust_invoice->user_id }}</td>
							...
							<td align="right">
						@php	
						if($cust_invoice->adv_rec != 0)
							  { $amount=$cust_invoice->adv_rec;
						}else { $amount=$cust_invoice->coll_amount; }
						@endphp	
							{{ $amount }}</td>
                            </tr>
							@php
							$ttotal=$amount+$ttotal;
