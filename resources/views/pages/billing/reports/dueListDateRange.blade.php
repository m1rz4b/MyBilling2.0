        ...
        <div class="container-fluid p-0 sm_padding_15px">
            <div class="">
                <div class="px-4 py-1 theme_bg_1">
                    <h5 class="mb-0 text-white text-center">Due List Date Range</h5>
                </div>
            </div>

            <form action="{{ route('duelistdaterange.show') }}" method="get">
                @csrf
                <div class="m-3">
                    <div class="row mb-3">
				  ...
				  <label class="fw-medium" for="end_date" class="form-label">Zone</label>
					...
					<h5 class="mb-0 text-center">Due List Date Range</h5>
