        ...
        <div class="container-fluid p-0 sm_padding_15px">
            <div class="">
                <div class="px-4 py-1 theme_bg_1">
                    <h5 class="mb-0 text-white text-center">Expiry Informaiton</h5>
                </div>
            </div>

            <form action="{{ route('expiry.show') }}" method="get">
				...
				<div class="col-sm-3">
					...
					<h5 class="mb-0 text-center">Expiry Informaiton</h5>
                </div>
